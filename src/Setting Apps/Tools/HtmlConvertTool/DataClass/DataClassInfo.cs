...
{
    public class DataClassInfo : IEqualityComparer<DataClassInfo>, IEquatable<DataClassInfo>
    {
        ...
        public bool Equals(DataClassInfo? x, DataClassInfo? y)
        ...
        public bool Equals(DataClassInfo? other)
        ...
        public int GetHashCode([DisallowNull] DataClassInfo obj)
