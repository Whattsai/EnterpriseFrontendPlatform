...
namespace Web.Actions.Aggregator.Controllers
{
    ...
    public class AggregateController : ControllerBase
    {
        ...
        {
            return await _daprClient.InvokeMethodAsync<ConcurrentDictionary<string, StateModel>, object>(HttpMethod.Post, $"{request.Service}middlewareservice", $"{request.ID}/responsemapper", stateModel);
        }
